-- create_public_hold: aplica la oferta last-minute (descuento) y la consume
...
begin
  ...
  -- Oferta last-minute: aplica el descuento al precio y consume la oferta.
...
-- public_court_day: expone las ofertas activas del día
